...
###########
#Uncomment the below lines when the Pibot model is trained to detect balls & shoeboxes

# Path to frozen detection graph. This is the actual model that is used for the object detection.
MODEL_NAME = 'ssd_mobilenet_v2_pibot_10_07_2018'
#MODEL_NAME = 'ssd_mobilenet_v1_coco_11_06_2017'
PATH_TO_CKPT = os.path.join(CWD_PATH ,'models', MODEL_NAME, 'frozen_inference_graph.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(CWD_PATH, 'data', 'pibot_label_map.pbtxt')
...
if __name__ == '__main__':
    ...
    pool = Pool(args.num_workers, image_processor.worker, (input_q, output_q))

    #video_capture = WebcamVideoStream(src=args.video_source,
    #                                  width=args.width,
     #                                 height=args.height).start()

    stream_processor = CameraThread.StreamProcessor(640,480, image_processor.image_process_entry, False)
    time.sleep(1)
