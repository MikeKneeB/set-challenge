...
PATH_TO_CKPT = os.path.join(CWD_PATH ,'models', 'model', 'train', 'darth_vader_inference_graph.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(CWD_PATH, 'data', 'darth_vader_label_map.pbtxt')
